...
<head>
  ...
  <style>
    * { font-family: 'Inter', sans-serif; }
    ...
    /* Sidebar */
    .sidebar { width: 260px; min-height: 100vh; background: #0f172a; position: fixed; top:0; left:0; z-index:40; display:flex; flex-direction:column; transition: transform .25s ease; }
    ...
    .sidebar-section { font-size:11px; font-weight:600; letter-spacing:.08em; color:#475569; text-transform:uppercase; padding:16px 26px 6px; }
    ...
    .data-table thead th { font-size:11px; font-weight:600; text-transform:uppercase; letter-spacing:.06em; color:#64748b; padding:10px 14px; text-align:left; background:#f8fafc; border-bottom:1px solid #e2e8f0; }
...
<aside class="sidebar" id="sidebar">
  ...
  <div style="padding:20px 20px 12px; border-bottom:1px solid rgba(255,255,255,.07);">
    <a href="<?= BASE_URL ?>/" style="display:flex; align-items:center; gap:10px; text-decoration:none;">
      ...
      <div>
        ...
        <div style="color:#475569;font-size:11px;">Fleet Intelligence</div>
      </div>
    </a>
  </div>
  ...
  <nav style="flex:1;padding:10px 0;overflow-y:auto;">
    ...
    <div class="sidebar-section">Flotte</div>
    ...
    <div class="sidebar-section">Portail client</div>
...
<div class="main-content">
  ...
  <header class="topbar">
    <div style="display:flex;align-items:center;gap:14px;">
      ...
      <div>
        <h1 style="font-size:16px;font-weight:600;color:#0f172a;line-height:1.2;"><?= $pageTitle ?? 'Tableau de bord' ?></h1>
