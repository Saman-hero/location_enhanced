...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:16px;margin-bottom:24px;">
  ...
  <div class="kpi-card">
    <div style="display:flex;justify-content:space-between;align-items:flex-start;">
      <div>
        ...
        <div class="kpi-label"><?= t('total_vehicles') ?></div>
      </div>
    ...
    <div style="margin-top:12px;display:flex;gap:10px;font-size:12px;">
      <span class="badge badge-green"><?= $stats['dispo'] ?> <?= t('available') ?></span>
      <span class="badge badge-blue"><?= $stats['loue'] ?> <?= t('rented') ?></span>
      <span class="badge badge-yellow"><?= $stats['maint'] ?> <?= t('in_maintenance') ?></span>
    </div>
  </div>
  ...
  <div class="kpi-card">
    <div style="display:flex;justify-content:space-between;align-items:flex-start;">
      <div>
        ...
        <div class="kpi-label"><?= t('active_reservations') ?></div>
      </div>
    ...
    <div class="kpi-trend" style="color:#3b82f6;"><?= t('util_rate') ?>: <?= $stats['util_rate'] ?>%</div>
  </div>
  ...
  <div class="kpi-card">
    ...
    <div class="kpi-trend <?= $stats['rev_trend'] >= 0 ? 'trend-up' : 'trend-down' ?>">
      <?= $stats['rev_trend'] >= 0 ? '▲' : '▼' ?> <?= abs($stats['rev_trend']) ?>% <?= t('vs_last_month') ?>
    </div>
  </div>
  ...
  <div class="kpi-card">
    <div style="display:flex;justify-content:space-between;align-items:flex-start;">
      <div>
        ...
        <div class="kpi-label"><?= t('active_clients') ?></div>
      </div>
      <div class="stat-icon" style="background:#eff6ff;">
    ...
    <div class="kpi-trend trend-down"><?= $stats['open_incidents'] ?> <?= t('open_incidents') ?></div>
    <?php else: ?>
    <div class="kpi-trend trend-up"><?= t('no_open_incidents') ?></div>
    <?php endif; ?>
  </div>
...
<div style="display:grid;grid-template-columns:2fr 1fr;gap:20px;margin-bottom:24px;">
  ...
  <div class="card">
    <div class="card-header">
      <span class="card-title"><?= t('monthly_reservations') ?></span>
    </div>
    <div class="card-body">
  ...
  <div class="card">
    <div class="card-header">
      <span class="card-title"><?= t('fleet_status') ?></span>
    </div>
    <div class="card-body" style="display:flex;flex-direction:column;align-items:center;">
      ...
      <div style="margin-top:14px;display:flex;flex-wrap:wrap;gap:8px;justify-content:center;">
        <span class="badge badge-green"><?= t('available') ?> (<?= $stats['dispo'] ?>)</span>
        <span class="badge badge-blue"><?= t('rented') ?> (<?= $stats['loue'] ?>)</span>
        <span class="badge badge-yellow"><?= t('in_maintenance') ?> (<?= $stats['maint'] ?>)</span>
      </div>
    </div>
  </div>
...
<div class="card">
  <div class="card-header">
    <span class="card-title"><?= t('recent_reservations') ?></span>
    ...
    <table class="data-table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a href="<?= BASE_URL ?>/?page=reservations/show&id=<?= $r['id'] ?>" class="btn btn-outline btn-sm"><?= t('btn_view') ?></a></td>
        </tr>
        <?php endforeach; ?>
        <?php if (empty($recentReservations)): ?>
        <tr><td colspan="8" style="text-align:center;color:#94a3b8;padding:32px;"><?= t('no_reservations') ?></td></tr>
        <?php endif; ?>
      </tbody>
    </table>
  </div>
