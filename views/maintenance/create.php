<?php $pageTitle = t('add_maintenance'); $pageBreadcrumb = t('maintenance').' › '.t('btn_new'); ?>
...
<div class="card">
  <div class="card-header">
    <span class="card-title"><?= t('add_maintenance') ?></span>
  ...
  <div class="card-body">
    <form method="POST">
      ...
      <div class="form-grid-2" style="margin-bottom:16px;">
        <div><label class="form-label"><?= t('scheduled_date') ?> *</label><input type="date" name="date_prevue" class="form-control" value="<?= h($data['date_prevue']) ?>" required></div>
