<?php $pageTitle = 'Planifier maintenance'; $pageBreadcrumb = 'Maintenance › Nouveau'; ?>
...
<div class="card">
  <div class="card-header">
    <span class="card-title">Planifier une maintenance</span>
  ...
  <div class="card-body">
    <form method="POST">
      ...
      <div class="form-grid-2" style="margin-bottom:16px;">
        <div><label class="form-label">Date prévue *</label><input type="date" name="date_prevue" class="form-control" value="<?= h($data['date_prevue']) ?>" required></div>
