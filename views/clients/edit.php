<?php $pageTitle = 'Modifier '.$data['prenom'].' '.$data['nom']; $pageBreadcrumb = 'Clients › Modifier'; ?>
...
<div class="card">
  <div class="card-header">
    <span class="card-title">Modifier <?= h($data['prenom'].' '.$data['nom']) ?></span>
    <a href="<?= BASE_URL ?>/?page=clients/show&id=<?= $id ?>" class="btn btn-outline btn-sm">← Retour</a>
  </div>
  <div class="card-body">
    <form method="POST">
      ...
      <div style="display:flex;gap:10px;">
        ...
        <a href="<?= BASE_URL ?>/?page=clients/show&id=<?= $id ?>" class="btn btn-outline">Annuler</a>
      </div>
    </form>
  </div>
</div>
