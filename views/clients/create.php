<?php $pageTitle = t('add_client'); $pageBreadcrumb = t('clients').' › '.t('btn_new'); ?>
...
<div class="card">
  <div class="card-header">
    <span class="card-title"><?= t('add_client') ?></span>
    <a href="<?= BASE_URL ?>/?page=clients" class="btn btn-outline btn-sm">← <?= t('btn_back') ?></a>
  </div>
  <div class="card-body">
    <form method="POST">
      ...
      <div style="display:flex;gap:10px;">
        ...
        <a href="<?= BASE_URL ?>/?page=clients" class="btn btn-outline"><?= t('btn_cancel') ?></a>
      </div>
    </form>
  </div>
</div>
